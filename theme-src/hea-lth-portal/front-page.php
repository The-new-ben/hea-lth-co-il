...
<section class="hp-hero hp-hero--anatomy" id="body-discovery">
	<div class="hp-shell hp-hero-anatomy">
		<div class="hp-hero-anatomy__intro">
			...
			<h1><?php esc_html_e( 'לוחצים על אזור בגוף — ורואים למי לפנות', 'hea-lth-portal' ); ?></h1>
			<p class="hp-hero__lede"><?php esc_html_e( 'סובבו את הגוף התלת ממדי, בחרו מבנה, וקבלו מיד מידע, תחומי מומחיות ושירותים מאומתים המחוברים לאותו אזור.', 'hea-lth-portal' ); ?></p>
			...
			<ul class="hp-hero__assurance" aria-label="<?php esc_attr_e( 'עקרונות המידע באתר', 'hea-lth-portal' ); ?>">
				<li><?php esc_html_e( 'לחיצה על מבנה מובילה לשירות מאומת', 'hea-lth-portal' ); ?></li>
				<li><?php esc_html_e( 'אטלס אנטומי להמחשה בלבד', 'hea-lth-portal' ); ?></li>
		...
		<div class="hp-hero-anatomy__viewer hp-anatomy-viewer" data-anatomy-viewer data-config-url="<?php echo esc_url( get_theme_file_uri( 'assets/data/anatomy-discovery-v1.json' ) ); ?>">
			...
			<div class="hp-hero-anatomy__stagewrap">
			...
			<div class="hp-hero-anatomy__panel">
				...
				<section class="hp-hero-anatomy__controls">
					<p><?php esc_html_e( 'הקשר', 'hea-lth-portal' ); ?></p>
					<div class="hp-anatomy-controls" data-anatomy-context-controls></div>
				</section>
				<div class="hp-anatomy-results hp-anatomy-results--hero" data-anatomy-results aria-live="polite"></div>
			</div>
		</div>
	</div>
</section>
